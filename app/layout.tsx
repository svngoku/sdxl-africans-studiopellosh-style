...
export const metadata: Metadata = {
  title: "SDXL Studio Pellosh",
  description:
    "Generate beautiful AI photo with the style of Studio Pellosh from Congo in 70s.",
        ...
        <div className="absolute w-full py-5 text-center">
          <p className="text-gray-500">
            ...
            <a
              ...
              href="https://twitter.com/cniongol"
              target="_blank"
              rel="noopener noreferrer"
            >
              Chrys NIONGOLO
          ...
          >
            ...
            <p className="font-medium text-gray-600">Follow me on Instagram</p>
          </a>
        </div>
        <Analytics />
      </body>
